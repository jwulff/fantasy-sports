...
architecture doc is being updated, not the brief.

| File | Question |
|---|---|
| `01-telemetry-auto-issues.md` | Semi-secure, flood-resistant auto-filing of GitHub issues from client errors |
